...
> 💡 *Each project solves a real-world business problem using data.*

| # | Project | Tools | What I Did |
|---|---------|-------|------------|
| 🥇 | [📚 Bookstore Management System](https://github.com/AryanshDhuria/SQL_PROJECT_BOOKSTORE) | SQL, MySQL | Built a full SQL database for inventory tracking, customer analysis & sales reporting |
| 🥈 | *Coming Soon* | Python, Pandas | EDA on a real-world dataset with visual insights |
| 🥉 | *Coming Soon* | Power BI | Interactive business dashboard with KPIs |
| 4️⃣ | *Coming Soon* | SQL + Excel | Data cleaning & reporting project |
